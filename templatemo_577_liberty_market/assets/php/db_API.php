...
foreach ($movies['results'] as $movie) {
	...
	//*** randomTicket Start ***
	$randomTicket = mt_rand(20, 40);
	//*** randomTicket End ***


	//*** randomPlace Start ***
	$randomPlace = mt_rand(12, 40);
	//*** randomPlace End ***


	//*** Discount Start ***
	$randNumDis = mt_rand(0, 1);
	$discount = ($randNumDis == 1) ? rand(10, 25) . "%" : "No discount now";
	//*** Discount End ***


	$randProfit = mt_rand(100000, 100000000);
	$formattedProfit = number_format($randProfit, 0, '', ' ');
