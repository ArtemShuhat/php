...
<body class="min-h-screen min-w-full flex items-center justify-center bg-mainBg">
    <div class="overflow-x-hidden bg-gray-100">
            ...
            <div class="container flex flex-col mx-auto md:flex-row md:items-center md:justify-between">
                <div class="flex items-center justify-between">
                    <div class="flex items-center">
                        ...
                        <a href="" class="text-xl font-bold text-gray-800 md:text-2xl" id="blogLink">Blog</a>
                    </div>
                </div>
                <div class="flex-col hidden md:flex md:flex-row md:-mx-4 items-center">
                    <a href="./error.html" class="my-1 text-gray-800 hover:text-gray-500 md:mx-4 md:my-0">Home</a>
                    <a href="./error.html" class="my-1 text-gray-800 hover:text-gray-500 md:mx-4 md:my-0">Blog</a>
                    <a href="#create_post" class="my-1 text-gray-800 hover:text-gray-500 md:mx-4 md:my-0">Create
                        Post</a>
                    <?php
                    ...
                    <?php } else { ?>
                        <a href="./assets/php/login.php"
                            class="my-1 text-gray-800 hover:text-gray-500 md:mx-4 md:my-0">Login</a>
                    <?php } ?>
                </div>
            </div>
        </nav>
        <div class="px-6 py-8" style="min-width:1328px">
            <div class="container flex justify-between mx-auto">
                <div class="w-full lg:w-8/12">
                        ...
                        <div>
                            <form method="get" action="index.php" id="sortForm">
                                ...
                                <select name="sort_option" id="sort_option" onchange="submitForm()">
                                    <option value="Latest" <?php echo (isset($_GET['sort_option']) && $_GET['sort_option'] == 'Latest') ? 'selected' : ''; ?>>Latest</option>
                                    <option value="Categories" <?php echo (isset($_GET['sort_option']) && $_GET['sort_option'] == 'Categories') ? 'selected' : ''; ?>>Categories</option>
                                </select>
                            </form>
                            <script>
                                function submitForm() {
                    ...
                    <?php include './assets/php/public_post.php'; ?>
                    ...
                    <div class="mt-8">
                        <div class="flex">
                            ...
                            for ($i = 1; $i <= $totalPages; $i++) {
                                echo "<a href='?page=$i' class='px-3 py-2 mx-1 font-medium text-gray-700 bg-white rounded-md hover:bg-gray-600 hover:text-white'>$i</a>";
                            }
                            ?>
                        </div>
                    </div>
                ...
                <div class="hidden w-4/12 -mx-8 lg:block">
                        ...
                        <div class="flex flex-col max-w-sm px-6 py-4 mx-auto bg-white rounded-lg shadow-md">
                            <ul class="-mx-4">
                                <li class="flex items-center"><img
                                    ...
                                    <p><a href="./error.html" class="mx-1 font-bold text-gray-700 hover:underline">Alex
                                ...
                                <li class="flex items-center mt-6"><img
                                        ...
                                        alt="avatar" class="object-cover w-10 h-10 mx-4 rounded-full">
                                    <p><a href="./error.html" class="mx-1 font-bold text-gray-700 hover:underline">Jane
                                ...
                                <li class="flex items-center mt-6"><img
                                        ...
                                        alt="avatar" class="object-cover w-10 h-10 mx-4 rounded-full">
                                    <p><a href="./error.html" class="mx-1 font-bold text-gray-700 hover:underline">Lisa
                                ...
                                <li class="flex items-center mt-6"><img
                                        ...
                                        alt="avatar" class="object-cover w-10 h-10 mx-4 rounded-full">
                                    <p><a href="./error.html" class="mx-1 font-bold text-gray-700 hover:underline">Steve
                                ...
                                <li class="flex items-center mt-6"><img
                                        ...
                                        alt="avatar" class="object-cover w-10 h-10 mx-4 rounded-full">
                                    <p><a href="./error.html"
                                            class="mx-1 font-bold text-gray-700 hover:underline">Khatab
                        ...
                        <div class="flex flex-col max-w-sm px-4 py-6 mx-auto bg-white rounded-lg shadow-md">
                            <ul>
                                <li><a href="./error.html"
                                        ...
                                        AWS</a></li>
                                <li class="mt-2"><a href="./error.html"
                                        class="mx-1 font-bold text-gray-700 hover:text-gray-600 hover:underline">-
                                        Laravel</a></li>
                                <li class="mt-2"><a href="./error.html"
                                        class="mx-1 font-bold text-gray-700 hover:text-gray-600 hover:underline">-
                                ...
                                <li class="mt-2"><a href="./error.html"
                                        class="mx-1 font-bold text-gray-700 hover:text-gray-600 hover:underline">-
                                        Design</a></li>
                                <li class="flex items-center mt-2"><a href="./error.html"
                                        class="mx-1 font-bold text-gray-700 hover:text-gray-600 hover:underline">-
                                        Django</a></li>
                                <li class="flex items-center mt-2"><a href="./error.html"
                                        class="mx-1 font-bold text-gray-700 hover:text-gray-600 hover:underline">-
                    ...
                    <div class="px-8 mt-10">
                        ...
                        <div class="flex flex-col max-w-sm px-8 pb-6 pt-2 mx-auto bg-white rounded-lg shadow-md">
                            <div class="mt-4"><a href="#create_post"
                            ...
                            <div class="flex items-center justify-between mt-4">
                                <div class="flex items-center"><img src="./assets/images/profileImg.png" alt="avatar"
                                    ...
                                    <?php
                                    if (isset($_SESSION['username'])) { ?>
                                        <a href="./error.html" class="mx-3 text-sm text-gray-700 hover:underline">
                                ...
                                <div class="flex items-center justify-between"><a href="#create_post"
        ...
        <footer class="px-6 py-2 text-gray-100 bg-gray-800">
            <div class="container flex flex-col items-center justify-between mx-auto md:flex-row"><a href="./error.html"
                    class="text-2xl font-bold">Blog</a>
                <p class="mt-2 md:mt-0">All rights reserved
                    <?php echo date("Y"); ?>.
                </p>
                <div class="flex mt-4 mb-2 -mx-2 md:mt-0 md:mb-0"><a href="./error.html"
                        ...
                        </svg></a><a href="./error.html" class="mx-2 text-gray-100 hover:text-gray-400"><svg
